...
module.exports = {
    ...
    SESSION: process.env.KALIPPANSER_CODE === undefined ? '' : process.env.KALIPPANSER_CODE,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Kalippanser' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '918281370025@s.whatsapp.net' : process.env.TAG_REPLY,
