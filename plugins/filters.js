...
const array = ['Aloo','para','aparnnamol','oggyser','pm','niya','Kalippan','dj','adida','Bgm','dai','Dai','kalippanserminnu','ketto','midhunsermass','nannam','pinne','Poda','rashu','song','you','X','Kalippanmass','aval','Baby','da','Fan','hi','Kalippan','Love','loveu','me','mess','midhun','Midhunser','mindila','miss','molu','ninne','Ok','palasaji','pinagale','samadhanam','sarasu','sona','tata','kalippanser','left','aliya','alone','aysheri','baby','bea','chill','don','helo','ishtta','kalippan','mathi','midhunser','minnu','my','nirthiko','otta','pavam','sed','single','Umma','vallakum','vave','vellachil','caption','Mrng','alive','Di','Bro','avan','converting','Allah','bg','help','Hii','odiko','oho','killadi','oo','Fuck','invite','Hi','love','Owner','Group','list','man','Nanba','oii','poda','yo','sad','work','set','remove','thukum','poko','myre,','kundan','xmedia','commands','Boss','vava','Myre','Lalitha','start','Adithhari','sing','Hello','Bye','warn','Baby','who','find','power','myr','vanam','tagall','Re entry','pass','patti','phaa','mone','look','bor','try','owner','luv','feel','romam','set','potte','no replay','bgm','vijay','poli']
array.map( async (a) => {
